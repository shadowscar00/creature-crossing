defmodule CreatureCrossing.Nookipedia.Stub do
  ...
  def list_villagers do
    {:ok, [
      ...
      villager("Judy", "Bear cub", "Snooty", "Female", "March", "10", "Pisces", "Nature", ["Pink", "Blue"], ["Cute", "Gorgeous"]),
      ...
      villager("Maple", "Bear cub", "Normal", "Female", "June", "15", "Gemini", "Nature", ["Beige", "Brown"], ["Cute", "Simple"]),
      villager("Stitches", "Bear cub", "Lazy", "Male", "February", "10", "Aquarius", "Play", ["Colorful", "Orange"], ["Cute", "Active"]),
